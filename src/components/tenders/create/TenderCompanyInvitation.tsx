...
const dummyCompanies = [
  { id: "comp-1", name: "Martin Construction" },
  { id: "comp-2", name: "Electricité Dupont" },
  { id: "comp-3", name: "CVC Solutions" },
  { id: "comp-4", name: "Durand & Fils Menuiserie" },
  { id: "comp-5", name: "Peinture Express" },
  { id: "comp-6", name: "Plomberie Générale" },
  { id: "comp-7", name: "Ascenseurs Modernes" },
  { id: "comp-8", name: "Façades & Co" },
  { id: "comp-9", name: "Charpentes Thomas" },
  { id: "comp-10", name: "Isolation Performante" },
];
    ...
    <div className="space-y-6">
      ...
      <div className="border rounded-md overflow-hidden">
        <div className="bg-muted p-2 border-b">
          <h3 className="font-medium">Entreprises disponibles</h3>
        </div>
            ...
            <div key={company.id} className="flex items-center justify-between p-3 hover:bg-muted/50">
              <div className="flex items-center">
                <Checkbox 
                  ...
                  onCheckedChange={() => handleCompanySelection(company)}
                />
