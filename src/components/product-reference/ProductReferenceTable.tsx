...
import { MapPin, Building, Mail, Phone, ExternalLink, Send, Clock, CheckCircle } from 'lucide-react';
          ...
          <TableBody>
            {references.map((reference) => (
              <TableRow key={reference.id}>
                ...
                <TableCell>
                  <div className="space-y-1">
                    <div className="font-medium">{reference.contractor.name}</div>
                  ...
                  <div className="flex gap-2">
                    {reference.quoteStatus === 'to-send' ? (
                      ...
                      <Button size="sm" variant="outline" asChild>
                        <a href={`/product-reference/${reference.id}`}>
