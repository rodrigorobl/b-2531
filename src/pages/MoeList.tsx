...
export default function MoeList() {
  ...
  // Sample data with project type added - same as TenderList
  ...
  // Filter and sort tenders - modified to only show realisation and services
  const filteredTenders = tenders
    .filter(tender => {
      // Filter by project type
      if (tender.projectType !== 'realisation' && tender.projectType !== 'services') {
        return false;
      }
  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="p-6">
          <h1 className="text-2xl font-bold mb-6">Liste des Appels d'Offres MOE</h1>
            ...
            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="text-lg flex justify-between items-center">
                  <span>Appels d'offres Réalisation & Services ({filteredTenders.length})</span>
